...
const createEmployee = async (req, res) => {
    try {
        ...
        // ✅ Set password as phone number and hash it
        const hashedPassword = await bcrypt.hash(phone, 10);

        const employee = new Employee({ 
            name, username, phone, email, password: hashedPassword, documents, city, role, branchName, branchId 
        });
        ...
        res.status(201).json({ 
            ...
            employee, 
            generatedPassword: phone  // ✅ Show the generated password (same as phone)
        });
    } catch (error) {
...
const updateEmployee = async (req, res) => {
    try {
        ...
        const allowedFields = (({ name, username, phone, email, documents, city, role, branchName, branchId }) => 
...
export default { createEmployee, loginEmployee, getAllEmployees, getEmployeeById, deleteEmployee, updateEmployee ,changePassword};
